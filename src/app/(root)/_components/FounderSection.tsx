...
//         <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600/15 via-purple-600/12 to-indigo-600/15 rounded-2xl blur-md opacity-30 group-hover:opacity-40 transition-opacity duration-300" />

//         <div className="relative frost-panel overflow-hidden rounded-2xl group hover:shadow-lg transition-shadow duration-300">
...
//               {/* Profile Icon Section */}
//               <div className="flex-shrink-0 relative animate-float">
//                 <div className="absolute -inset-2 bg-white/6 rounded-full blur-lg opacity-30" />
//                 <div className="relative w-48 h-48 rounded-full overflow-hidden ring-1 ring-white/8 bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center">
//                   <div className="relative">
//                     <Code2 className="w-24 h-24 text-white/80" />
//                     <div className="absolute inset-0 bg-gradient-to-r from-blue-400/8 to-purple-400/8 rounded-full transition-opacity duration-500 opacity-60 group-hover:opacity-70" />
//                   </div>
//                 </div>
...
//                 <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-2xl">
//                   I design developer-first products and learning systems that shrink the distance between idea and impact. As a full‑stack engineer with a product mindset, I build scalable tools and experiences using modern web technologies and scalable infrastructure—helping teams ship confidently and learners level up faster. If you’re building something ambitious or want a stronger developer experience, let’s connect and build together.
//                 </p>
...
//                     <span
//                       key={tech}
//                       className="px-3 py-1.5 bg-white/5 text-gray-300 rounded-full text-sm font-medium ring-1 ring-white/6 hover:ring-white/12 transition-all duration-200"
//                     >
//                       {tech}
//                     </span>
//                   ))}
...
//                     className="group relative p-3 rounded-lg bg-zinc-900 ring-1 ring-zinc-800 hover:ring-white/20 transition-all duration-300"
//                   >
//                     <Github className="w-5 h-5 text-white group-hover:scale-105 transition-transform duration-300" />
//                     <div className="absolute -inset-1 bg-white/4 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
//                   </Link>
...
//                     className="group relative p-3 rounded-lg bg-zinc-900 ring-1 ring-zinc-800 hover:ring-white/20 transition-all duration-300"
//                   >
//                     <Linkedin className="w-5 h-5 text-white group-hover:scale-105 transition-transform duration-300" />
//                     <div className="absolute -inset-1 bg-blue-500/8 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
//                   </Link>
...
//                     className="group relative p-3 rounded-lg bg-zinc-900 ring-1 ring-zinc-800 hover:ring-white/20 transition-all duration-300"
//                   >
//                     <Twitter className="w-5 h-5 text-white group-hover:scale-105 transition-transform duration-300" />
//                     <div className="absolute -inset-1 bg-sky-500/8 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
//                   </Link>

//                   {/* Connect CTA */}
//                   <Link
//                     href="mailto:developeradityasharma@gmail.com"
//                     className="group relative inline-flex items-center gap-2 px-4 py-3 ml-4 bg-white text-black rounded-lg font-medium transition-all duration-300 hover:bg-gray-200 hover:scale-105"
//                   >
//                     <span>Let's Connect</span>
//                     <ExternalLink className="w-4 h-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
...
//                 <div className="absolute left-0 top-0 text-6xl text-white/10 font-serif leading-none">"</div>
//                 <p className="text-gray-300 text-lg italic pl-8 max-w-4xl">
//                   Every line of code in Replix is written with the belief that great tools should be accessible to everyone. My mission is to empower developers worldwide with an IDE that doesn't just work—it inspires.
//                 </p>
//               </div>
//             </div>
//           </div>
