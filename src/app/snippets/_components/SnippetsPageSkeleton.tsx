    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="fixed inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          <div className="absolute top-[20%] -left-1/4 w-96 h-96 bg-zinc-700/20 rounded-full blur-3xl" />
          <div className="absolute top-[20%] -right-1/4 w-96 h-96 bg-zinc-800/20 rounded-full blur-3xl" />
        </div>
