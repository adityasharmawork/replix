...
//           "To build the most developer-centric online coding platform for every developer on the planet."
//         </p>
//       </div>
//     </div>
//   );
...
// app/_components/MissionSection.tsx
...
//         <div className="absolute -inset-1 bg-gradient-to-r from-green-400/20 via-blue-400/20 to-purple-400/20 blur-3xl opacity-40 rounded-3xl" />
  ...
  return (
    <section className="max-w-5xl mx-auto my-40 px-6 text-center animate-fade-in">
      <div className="relative group transition-all duration-300 hover:scale-101 hover:-translate-y-1">
        <div className="absolute -inset-1 bg-gradient-to-r from-green-400/20 via-blue-400/20 to-purple-400/20 blur-3xl opacity-40 rounded-3xl transition-opacity duration-300 group-hover:opacity-60" />
        <div className="relative frost-panel p-10 rounded-3xl shadow-lg transition-all duration-300 group-hover:shadow-[0_0_25px_rgba(110,231,183,0.25)]">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-zinc-900 ring-1 ring-zinc-800 mb-6">
            <Rocket className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-4">Our Mission</h2>
...
//                         from-green-400/15 via-blue-400/15 to-purple-400/15 
