...
import RunningCodeSkeleton from "../../editor/_components/RunningCodeSkeleton";

function PracticeOutputPanel () {
  ...
  return (
    <div className="relative h-full min-h-56 flex flex-col">
...
export default PracticeOutputPanel