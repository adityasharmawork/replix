      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute top-full ${fullWidth ? 'right-0 left-0 mx-2 sm:mx-0 sm:left-auto' : 'left-0'} mt-2 w-full min-w-[200px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50`}
          >
